...
from apiclients.mistral import MistralClient
...
logger = CustomLogger(name="Attr. Prompting Mistral")
...
def main():
    ...
    mistral_client = MistralClient(email_gen)
    batch_number = 1
    ...
    while total_samples > 0:
        ...
        mistral_client.run_batch_inference(batch_filename, number_samples=batch_size)
