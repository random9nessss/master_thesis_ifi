...
from zeroshotprompting.zeroshot_anthropic import AnthropicZeroShotClient
...
logger = CustomLogger(name="Zero Shot Prompting Anthropic")
...
def main():
    ...
    anthropic_client = AnthropicZeroShotClient(mode="fewshot")
    ...
    while total_samples > 0:
        ...
        anthropic_client.run_batch_inference(number_samples=batch_size)
        wait_for_all_jobs(anthropic_client)
