...
from zeroshotprompting.zeroshot_openai import OpenAIZeroShotClient
...
logger = CustomLogger(name="Zero Shot Prompting OpenAI")
...
def main():
    ...
    openai_client = OpenAIZeroShotClient(mode="fewshot")
